...
<BaseList>
  <ShowCodeBlock>
    ...
    >
      ...
      <Typography sx={{fontSize: "0.9em", textOverflow: "ellipsis", overflow: "hidden", whiteSpace: "nowrap"}}>
        <strong>Resumo de:</strong> quinta-feira: Páscoa com menos vagas temporárias;<br/>chuva no feriadão e outras
        notícias.
      </Typography>
  ...
  <ShowCodeBlock>
    ...
    >
      ...
      >
        ...
        <IconButton aria-label="bluetooth">
